    ...
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="border-b mb-5 flex justify-between text-sm">
            <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
                ...
                <a href="#" class="font-semibold inline-block">Games Blog</a>
            </div>
            <a href="#">See All</a>
        </div>
        ...
        <div  class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            ...
            <!-- CARD 1 -->
            <div v-for="item in paginatedData" :key="item.id" class="rounded overflow-hidden shadow-lg flex flex-col">
            <!-- {{ item }} -->

                <div class="relative"><a href="#">
                        <img class="w-full"
                            :src="item.thumbnail ? item.thumbnail : 'https://via.placeholder.com/150'"
                ...
                <div class="px-6 py-4 mb-auto">
                    <a href="#"
                        class="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">{{ item.title }}</a>
                ...
                <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                    ...
                    <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                        ...
                        <span class="ml-1">{{ item.genre }}</span>
                    </span>
                </div>
            </div>

        </div>
        <Pagination :totalItems="data_game.length" :itemsPerPage="itemsPerPage"
...
<script setup lang="ts">
    ...
    const paginatedData = computed(() => {
        ...
        return data_game.value.slice(start, start + itemsPerPage.value);
    });
    ...
    const fetchData = async () => {
        try {
            ...
            const { data } = await axios.get('http://127.0.0.1:3001/api/data');

            data_game.value = data
    ...
    // Memanggil fetchData ketika komponen dimounting
    onMounted(() => {
        fetchData()
    })
</script>